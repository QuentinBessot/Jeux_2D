...
public class Inventory : MonoBehaviour
{
    ...
    public PayerEffect playerEffect;
    ...
    public void ConsumeItem() 
    {
        ...
        playerEffect.AddSJump(currentItem.jumpGiven, currentItem.jumpDuration);
